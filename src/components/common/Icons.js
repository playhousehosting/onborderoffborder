...
export const MailIcon = (props) => (
  <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 9v.906a2.25 2.25 0 01-1.183 1.981l-6.478 3.488M2.25 9v.906a2.25 2.25 0 001.183 1.981l6.478 3.488m12-6.374a2.25 2.25 0 00-1.183-1.981L12.75 7.125a2.25 2.25 0 00-2.5 0L3.183 9.819A2.25 2.25 0 002 11.812V12m18.75-3v12.75A2.25 2.25 0 0118.5 24h-13A2.25 2.25 0 013 21.75V9m18.75 0l-6.478 3.488M3 9l6.478 3.488" />
  </svg>
);
...
export const ServerIcon = (props) => (
  <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 14.25h13.5m-13.5 0a3 3 0 01-3-3m3 3a3 3 0 003 3m13.5-9a3 3 0 00-3-3m-10.5 0a3 3 0 00-3 3m0 0v9a3 3 0 003 3h10.5a3 3 0 003-3v-9a3 3 0 00-3-3m-13.5 0a3 3 0 013-3h10.5a3 3 0 013 3m-13.5 0h10.5m-10.5 9v6m10.5-6v6" />
  </svg>
);
...
export const UploadIcon = (props) => (
  <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M7.5 10.5L12 6m0 0l4.5 4.5M12 6v12" />
  </svg>
);
